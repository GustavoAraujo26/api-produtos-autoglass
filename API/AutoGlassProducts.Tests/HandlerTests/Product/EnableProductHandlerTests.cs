...
{
    public class EnableProductHandlerTests
    {
        private readonly Mock<IProductRepository> _productRepositoryMock;
        private readonly CancellationTokenSource _cts;

        public EnableProductHandlerTests()
        {
        ...
        public async Task WhenValidRequest_ReturnSuccess()
        {
            ...
            var request = EnableProductRequestFakeData.BuildValid();

            var handler = serviceCollection.GetService<IEnableProductHandler>();
        ...
        public async Task WhenInvalidRequest_ReturnFailure()
        {
            ...
            var request = EnableProductRequestFakeData.BuildInvalid();
