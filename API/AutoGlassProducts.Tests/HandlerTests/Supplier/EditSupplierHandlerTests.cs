...
{
    public class EditSupplierHandlerTests
    {
        ...
        public async Task WhenValidRequest_ReturnSuccess()
        {
            ...
            var request = EditSupplierRequestFakeData.BuildValid();

            var handler = serviceCollection.GetService<IEditSupplierHandler>();
        ...
        public async Task WhenInvalidRequest_ReturnFailure()
        {
            ...
            var request = EditSupplierRequestFakeData.BuildInvalid();
